...
//         | "warning"
//         | "success";
//     size?: "h1" | "h2" | "h3" | "h4" | "large" | "medium" | "small";
//     className?: string;
//     hover?: boolean;
//     active?: boolean;
// }): JSX.Element => {
...
//         large: <p className={_className}>{children}</p>,
//         medium: <p className={_className}>{children}</p>,
//         small: <p className={_className}>{children}</p>,
//     }[size];
// };
