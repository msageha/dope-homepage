...
const CompanyMission = () => {
  ...
  return (
    <div className="container mx-auto my-8 px-10">
      ...
      <p className={descriptionClasses} style={{ whiteSpace: "pre-line" }}>
        {description}
      </p>
    </div>
  );
  ...
  const values = [
    {
      ...
      description: "データを使ったイノベーションの発見、新しい可能性を提供",
    },
    {
      title: "Optimize Performance",
      description: "最適化されたパフォーマンスにより、効率的で高い業績を達成",
    },
    {
  ...
  return (
    <div className="container mx-auto my-8 px-10">
      ...
      <p className={descriptionClasses}>
        ...
        <br />　<span className="font-semibold">Discover（発見する）</span>、
      ...
      <ul className="mb-8">
        {values.map((policy, index) => (
          <li key={index}>
            ...
            <p className={`mb-6 ${descriptionClasses}`}>{policy.description}</p>
          </li>
        ))}
      </ul>
    </div>
